...
public class NetworkTrafficQs extends TextView {
        ...
        public void handleMessage(Message msg) {
            ...
            if (shouldHide(rxData, txData, timeDelta)) {
                ...
                if (isSet(mState, MASK_UP + MASK_DOWN)) {
                    output += "\n";
                    txtSize = txtSizeMulti;
                } else {
                    txtSize = txtSizeSingle;
                }
    ...
    class SettingsObserver extends ContentObserver {
        ...
        void observe() {
            ...
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.NETWORK_TRAFFIC_STATE_QS), false,
                    this, UserHandle.USER_ALL);
            resolver.registerContentObserver(Settings.System
                    .getUriFor(Settings.System.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD_QS), false,
                    this, UserHandle.USER_ALL);
        }
    ...
    public NetworkTrafficQs(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTintColor = resources.getColor(R.color.assist_orb_color);
    ...
    private void updateSettings() {
        ...
        mAutoHideThreshold = Settings.System.getIntForUser(resolver,
                Settings.System.NETWORK_TRAFFIC_AUTOHIDE_THRESHOLD_QS, 1,
                UserHandle.USER_CURRENT);
        mState = Settings.System.getInt(resolver, Settings.System.NETWORK_TRAFFIC_STATE_QS, 0);
